...
public class KafkaConsumerConfig {
    public static final String GROUP_ID = "Campaign";

    @Bean
    public ConsumerFactory<String, AuthMessage> consumerFactory() {
        ...
        jsonDeserializer.addTrustedPackages("com.zion.bean");

        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), jsonDeserializer);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AuthMessage> actionListener() {
